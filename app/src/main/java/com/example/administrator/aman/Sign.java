...
public class Sign extends  BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Views
        mEmailField = (EditText) findViewById(R.id.pusernames);
        mPasswordField = (EditText) findViewById(R.id.ppassword2);
        mSignInButton = (Button) findViewById(R.id.checkLogin);
        mSignUpButton = (Button) findViewById(R.id.checkSign);
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Go to MainActivity
        startActivity(new Intent(Sign.this, WelcomePage.class));
        finish();
    }
